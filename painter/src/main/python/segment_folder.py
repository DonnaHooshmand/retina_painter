...
class SegmentFolderWidget(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        format_label.setText("Segmentation Format: RetinaPainter Default")
        layout.addWidget(format_label)
        self.format_label = format_label
        self.format_dropdown = QtWidgets.QComboBox()
        self.format_dropdown.addItems(['RetinaPainter Default (.png)', 'RhizoVision Explorer (.png)'])
        # nobody needs numpy yet
        # self.format_dropdown.addItems(['RetinaPainter Default (.png)', 'RhizoVision Explorer (.png)', 'Numpy Compressed (.npz)'])
