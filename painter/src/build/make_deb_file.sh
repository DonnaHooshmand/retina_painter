...
cp src/build/RetinaPainter.desktop dist/ubuntu_setup/usr/share/applications


mkdir dist/ubuntu_setup/DEBIAN
cp -r src/build/DEBIAN_control dist/ubuntu_setup/DEBIAN/control
cp -r dist/RetinaPainter dist/ubuntu_setup/usr/local/bin/RetinaPainter
cp -r src/main/icons dist/ubuntu_setup/usr/local/bin/RetinaPainter/icons

dpkg-deb --build dist/ubuntu_setup
mv dist/ubuntu_setup.deb dist/RetinaPainter.deb
echo 'output debian package to dist/RetinaPainter.deb'
